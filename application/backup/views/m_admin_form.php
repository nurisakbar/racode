<!-- Main content -->
	    ...
	    <tr><td>Kon Id <?php echo form_error('kon_id') ?></td>
            <td><input type="text" class="form-control" name="kon_id" id="kon_id" placeholder="Kon Id" value="<?php echo $kon_id; ?>" />
        </td>
