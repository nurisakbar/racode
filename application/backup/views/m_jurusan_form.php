<!-- Main content -->
            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  ...
                  <h3 class='box-title'>M_JURUSAN</h3>
                      <div class='box box-primary'>
        <form action="<?php echo $action; ?>" method="post"><table class='table table-bordered'>
	    <tr><td>Jurusan <?php echo form_error('jurusan') ?></td>
            <td><input type="text" class="form-control" name="jurusan" id="jurusan" placeholder="Jurusan" value="<?php echo $jurusan; ?>" />
        </td>
	    ...
	    <a href="<?php echo site_url('jurusan') ?>" class="btn btn-default">Cancel</a></td></tr>
