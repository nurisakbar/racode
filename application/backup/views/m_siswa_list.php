            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>M_SISWA LIST <?php echo anchor('siswa/create/','Create',array('class'=>'btn btn-danger btn-sm'));?>
	    ...
	    <tbody>
			...
			echo '  '; 
			echo anchor(site_url('siswa/update/'.$siswa->id),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-danger btn-sm')); 
			echo '  '; 
